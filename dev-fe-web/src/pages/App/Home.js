...
const Home = () => {
    ...
    return (_jsx(PortalLayout, { children: _jsx("div", { style: { flex: 0.9 }, children: _jsx(FullCalendar, { locale: "vi", plugins: [dayGridPlugin, listPlugin, interactionPlugin], initialView: viewMode, eventTextColor: "white" // Màu chữ trắng
