...
const SidebarTrigger = React.forwardRef(({ className, onClick, ...props }, ref) => {
    ...
    return (_jsxs(Button, { ref: ref, "data-sidebar": "trigger", variant: "ghost", size: "icon", className: cn("h-7 w-7 bg-transparent border-none focus:outline-none", className), onClick: (event) => {
            onClick?.(event);
            toggleSidebar();
